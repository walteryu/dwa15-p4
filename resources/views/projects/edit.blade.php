...
@section('content')
    ...
    <form method='POST' action='/project/edit'>
        ...
        @foreach( $project as $key => $value )
            ...
            <div class='form-group'>
               <label>owner_company_zipcode:</label>
                <input
                    type='text'
            ...
            <div class='form-group'>
               <label>owner_company_state:</label>
                <input
                    type='text'
            ...
            <div class='form-group'>
               <label>contractor_company_zipcode:</label>
                <input
                    type='text'
            ...
            <div class='form-group'>
               <label>contractor_company_state:</label>
                <input
                    type='text'
            ...
            <div class='form-group'>
               <label>wpcm_company_zipcode:</label>
                <input
                    type='text'
            ...
            <div class='form-group'>
               <label>wpcm_company_state:</label>
                <input
                    type='text'
            ...
            <div class='form-group'>
               <label>qsp_company_zipcode:</label>
                <input
                    type='text'
